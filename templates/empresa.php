...
<div class="container">
	<div class="row">
		<div class="col-xs-8 col-md-12">
			<h3 class="section-line section-tittle">Nosotros</h3>
		</div>
		<div class="col-xs-8 col-md-8">
			<!-- #content -->
			<h3>Carina y Los Fierros del Campo</h3>
			<div class="foto-flia">
			...
			<br>
			<p>Carina no es una simple vendedora que convence a sus clientes con su simpatía. A esa figura de empresaria, le suma sus conocimientos sobre el tema y su dinámica para atender en cualquier lugar de la región a quienes confían en sus productos, dándole así a su establecimiento un perfil que lo caracteriza con relación el resto.</p>
			<br>
			<p>Las fotos que acompañan estos párrafos, fueron tomadas en su centro de ventas en Necochea, en Ruta 228 y Km. 2</p>
		<!-- end - .post -->
		<div class="fotos-empresa">

		<ul>
			<li>
				<div class="col-md-6 col-xs-10">
					<a href="files/IMG_2970-1024x768.jpg" class="image-zoom home-thumb-zoom">
					<figure>
						<img src="files/IMG_2970-1024x768.jpg" class="img-responsive">
					</figure>
					</a>
					<figcaption>Aquí, Carina consultando todas las últimas informaciones relacionadas con su tarea</figcaption>
				</div>
		</li>
		<li>
			<div class="col-md-6 col-xs-10">

			<a href="files/IMG_2973-1024x768.jpg" class="image-zoom home-thumb-zoom">
				<figure>
					<img src="files/Necochea-20130219-01614.jpg" class="img-responsive">
				</figure>
			</a>
			<figcaption>En un Pauny linea Evo, con sus hijos Juanse y Mateo</figcaption>
		</div>
		</li>
	</ul>
</div>
